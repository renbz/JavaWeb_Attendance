...
function saveButton(){
 document.forms[0].action="${pageContext.request.contextPath}/R06_UserUpdateServlet";
...
<body>
<form action="${pageContext.request.contextPath}/R06_UserUpdateServlet" method="post">
	<div class="place">
    <span>位置：</span>
    <ul class="placeul">
    <li><a href="#">用户管理</a></li>
    ...
    <li>
      ...
      </label><input name="account" type="text" class="scinput" value="${user.account}" /></li>
        <%--//隐藏域提交id--%>
    ...
    <li>
     ...
     <li>
      <label>确认密码 <font color="red">*</font></label><input name="" type="password" class="dfinput" value="${user.password}"/>
    </li>
    <li>
     ...
     <li><label>部门</label>  
        ...
        <select class="select3" name="department_id">
            ...
            <c:if test="${user.department_id==10001}">
                <option>--请选择--</option>
            ...
            <c:if test="${user.department_id==10002}">
                <option>--请选择--</option>
                <option name="departId" value="10001" selected = "selected">研发一部</option>
                <option name="departId" value="10002">研发二部</option>
                <option name="departId" value="10003">研发三部</option>
            ...
            <c:if test="${user.department_id==10003}">
                <option>--请选择--</option>
            ...
            <c:if test="${user.department_id==10004}">
                <option >--请选择--</option>
                <option name="departId" value="10001" >研发一部</option>
                <option name="departId" value="10002" >研发二部</option>
                <option name="departId" value="10003" >研发三部</option>
            ...
            <c:if test="${user.department_id==10005}">
                <option>--请选择--</option>
                <option name="departId" value="10001">研发一部</option>
                <option name="departId" value="10002">研发二部</option>
                <option name="departId" value="10003">研发三部</option>
