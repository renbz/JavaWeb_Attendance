...
<body>
    ...
    <div class="tools">
    	...
    	<ul class="toolbar">
        <li class="click"><span><img src="../images/t01.png" /></span><a href="/workmanager/workInsert.jsp" target="_self">添加</a></li>
        <li class="click"><img src="../images/trash.png" /></span><a href="/workmanager/workUpdate.jsp" target="rightFrame">删除</a></li>
        </ul>
    </div>
        ...
        <tr>
          <td><table class="tablelist">
              ...
              <tr>
                  ...
                  <td>${wrs.end_time}</td>
                  <td>${wrs.work_time}</td>
                  <c:if test="${wrs.state==0}">
                  <td>申请中</td>
                  </c:if>
                  <c:if test="${wrs.state==1}">
                  <td>已通过</td>
                  </c:if>
                  <c:if test="${wrs.state==2}">
                  <td>已驳回</td>
                  </c:if>
                  <td><span><a href="workDetail.html" target="_self" class="tablelink"><img src="../images/user_edit.png" />详细</a>
                      <a href="/R03_DealWorkReServlet?id=${wrs.record_id}" class="tablelink" onclick="confirm('确定要删除吗？')"> <img src="../images/trash.png" />删除</a></span></td>
                  </c:forEach>
                <%--<tr>
        ...
        <ul class="paginList">
            ...
            <c:forEach begin="1" end="${pb.totalPage}" var="i">
                <c:if test="${pb.currentPage==i && (i <=5 || i >=pb.totalPage-4)}">
                    <li class="paginItem current"><a href="${pageContext.request.contextPath}/R01_FindWorkReByPageServlet?currentPage=${i}&rows=5">${i}</a></li>
                </c:if>
                <c:if test="${pb.currentPage!=i && (i <=5 || i >=pb.totalPage-4)}">
                    <li class="paginItem"><a href="${pageContext.request.contextPath}/R01_FindWorkReByPageServlet?currentPage=${i}&rows=5">${i}</a></li>
                </c:if>
                <c:if test="${i == 6 }">
                    <li class="paginItem more"><a href="javascript:;">...</a></li>
                </c:if>
