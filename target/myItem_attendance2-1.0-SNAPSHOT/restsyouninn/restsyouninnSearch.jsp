        ...
        <tr>
          <td><table class="tablelist">
              ...
              <tr>
                  ...
                  <td>${rrs.end_time}</td>
                  <td>${rrs.rest_cause}</td>
                  <td><span><a href="${pageContext.request.contextPath}/R02_PassRestServlet?id=${rrs.rest_id}" class="tablelink"><img src="../images/valid.png" onclick="confirm('确定审核通过吗？')"/></a>
                   <a href="${pageContext.request.contextPath}/R03_RefuseRestServlet?id=${rrs.rest_id}" class="tablelink" onclick="confirm('确定要驳回？')"> <img src="../images/error.png" /></a></span></td>
                  </c:forEach>
         ...
         <li class="paginItem"><a href="javascript:;"><span class="pagepre"></span></a></li>
            <c:forEach begin="1" end="${pb.totalPage}" var="i">
                <c:if test="${pb.currentPage==i && (i <=5 || i >=pb.totalPage-4)}">
                    <li class="paginItem current"><a href="${pageContext.request.contextPath}/R01_FindRestByPageServlet?currentPage=${i}&rows=5">${i}</a></li>
                </c:if>
                <c:if test="${pb.currentPage!=i && (i <=5 || i >=pb.totalPage-4)}">
                    <li class="paginItem"><a href="${pageContext.request.contextPath}/R01_FindRestByPageServlet?currentPage=${i}&rows=5">${i}</a></li>
                </c:if>
                <c:if test="${i == 6 }">
