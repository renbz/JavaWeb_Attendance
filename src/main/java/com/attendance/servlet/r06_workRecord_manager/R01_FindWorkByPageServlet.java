 ...
 * 2020/12/17
 */
@WebServlet("/R01_FindWorkByPageServlet")
public class R01_FindWorkByPageServlet extends HttpServlet {
    @Override
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        //7. 转发到数据显示页面
        request.getRequestDispatcher("/worksyouninn/worksyouninnSearch.jsp").forward(request,response);
    }
