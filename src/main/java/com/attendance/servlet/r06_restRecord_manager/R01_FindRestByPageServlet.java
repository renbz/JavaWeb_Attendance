 ...
 * 2020/12/17
 */
@WebServlet("/R01_FindRestByPageServlet")
public class R01_FindRestByPageServlet extends HttpServlet {
    @Override
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        //7. 转发到数据显示页面
        request.getRequestDispatcher("/restsyouninn/restsyouninnSearch.jsp").forward(request,response);
